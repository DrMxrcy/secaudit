---
name: data-access
description: Audits data access and input validation — SQL injection, ORM operator injection (e.g. Prisma filter injection and $queryRawUnsafe), runtime input validation at every boundary with a schema validator (Zod/Yup/Joi), and mass assignment from spread request bodies. Use whenever writing or reviewing database queries, API handlers, Server Actions, webhook handlers, or form/URL input processing, or when auditing how untrusted input reaches the data layer.
license: MIT
---
